...
FILE_EXISTS: str = "📍 File '{}' exists: {}"

INIT_COLD_STORAGE: str = "🚀 ColdStorage initialized and ready."
...
FILE_VALIDATED: str = "✅ File '{}' is checksum valid"
INTEGRITY_CHECK_FAILED: str = "❗ Integrity check failed for the following files:"
GENERATING_REPORT: str = "📋 Generating final verification report..."
